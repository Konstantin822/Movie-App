...
export interface ApiMovieCollectionMovieCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'movie_collections';
  info: {
    singularName: 'movie-collection';
    pluralName: 'movie-collections';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::movie-collection.movie-collection'
    >;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      'api::movie-collection.movie-collection': ApiMovieCollectionMovieCollection;
